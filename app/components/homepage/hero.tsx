    ...
    <section className="relative h-[100vh] overflow-x-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 z-20 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center">
        <div className="text-secondary mx-auto flex w-md max-w-screen flex-col items-center justify-center gap-6 px-4 md:w-4xl xl:w-[1200px] xl:gap-4 xl:px-0">
          <p className="text-md animate-fade-down animate-delay-200 tracking-[0.2em] md:text-xl xl:text-2xl">
            Delhi's culinary landscape
          </p>
          <h1 className="text-secondary animate-fade-down animate-delay-400 text-center text-4xl md:text-7xl xl:text-8xl">
            A Food Tale of Two Cities <br /> Old Delhi & New Delhi, india.
          </h1>
          <p className="font-script animate-fade-down animate-delay-600 text-center text-3xl leading-[0.5] text-wrap md:text-5xl xl:mt-5 xl:text-6xl xl:leading-normal">
            a welcoming embrace in the heart of New York City
          </p>
          <div className="animate-fade-down animate-delay-800 flex gap-2 md:gap-6 xl:w-[400px]">
